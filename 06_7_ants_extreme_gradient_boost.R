...
#' Key elements of extreme gradient boosting illustrated with the ants data. We
#' are now adding the algorithmic strategies of random forest (random selection
#' of data and variables) to the "learning slowly" strategy of boosting.
...
#' Basic **extreme gradient boosting** adds random selection of rows (data) and
#' columns (variables) to the boosting algorithm on each iteration.

#' An extreme gradient boosting regression tree algorithm:
#' ```
#' load y, x, xnew
