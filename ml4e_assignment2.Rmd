...
```
```{r q1-plot1, fig.width=10, fig.height=8}
...
```
```{r q1-plot2, fig.width=10, fig.height=8}
...
```
```{r q3-single-plot, fig.width=10, fig.height=6}
# Plot the result
...
```
```{r q3-comparison-plot, fig.width=10, fig.height=6}
# Compare both runs
...
```
```{r q3-multiple-replicates, cache=TRUE}
...
```
```{r q3-stable-plot, fig.width=10, fig.height=6}
...
```
```{r q4-visualization, fig.width=10, fig.height=6}
...
```
```{r q5-map-final, fig.width=10, fig.height=8}
