...
![](05_2_ants_bag_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
...
![](05_2_ants_bag_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
![](05_2_ants_bag_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
So one run of 5-fold CV with `cv_ants` takes a little over 2 seconds on
my laptop. Thus, 250 reps using the `for` loop above would take about 9
minutes:
...
That completed in 2 minutes, about a 3.5X speedup. A rough rule of thumb
...
16 cores. Some computers also have multiple virtual cores for each
hardware core. To find out how many cores your computer has:
...
to use all the virtual cores. On some systems, maximum performance is
...
![](05_2_ants_bag_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->
...
![](05_2_ants_bag_files/figure-gfm/unnamed-chunk-21-1.png)<!-- -->
...
![](05_2_ants_bag_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->
...
![](05_2_ants_bag_files/figure-gfm/unnamed-chunk-25-1.png)<!-- -->
...
![](05_2_ants_bag_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
